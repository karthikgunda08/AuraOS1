...
import { PhoenixEnginePanelProps, LokaSimulatorReport } from '../../types';
...
export const LokaSimulatorTool: React.FC<PhoenixEnginePanelProps> = (props) => {
    const { currentUser, onBuyCreditsClick, refreshCurrentUser, currentProject, lokaSimulatorReport, setLokaSimulatorReport } = props;
    ...
    return (
        <div>
            <h3 className="text-lg font-bold text-sky-300">Loka Simulator</h3>
            <p className="text-sm text-slate-300 my-3">Simulate real-world environmental data for your project's location. This helps in making informed decisions for sustainable design.</p>
