...
import { PhoenixEnginePanelProps, ProjectData, GeneratedRender } from '../../types';
...
export const RenderTool: React.FC<PhoenixEnginePanelProps> = (props) => {
    const { levels, activeLevelIndex, currentUser, onBuyCreditsClick, refreshCurrentUser, planNorthDirection, propertyLines, terrainMesh, currentProject, setGeneratedRenders } = props;
    ...
    return (
        <div>
            ...
            >
                ...
                <span className="text-xs bg-black/30 px-2 py-0.5 rounded-full">5 credits</span>
            </button>
