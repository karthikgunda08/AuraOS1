...
import { PhoenixEnginePanelProps, NexusReport } from '../../types';
...
export const NexusAdvisorTool: React.FC<PhoenixEnginePanelProps> = (props) => {
    const { 
        ...
        onBuyCreditsClick: state.onBuyCreditsClick,
    ...
    }, [projects, currentUser, onBuyCreditsClick, refreshCurrentUser, setNexusReport, addNotification]);
