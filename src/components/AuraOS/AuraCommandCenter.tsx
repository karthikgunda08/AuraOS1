// src/components/AuraCommandCenter.tsx
import React, { useState, useEffect, useCallback, Suspense } from 'react';
import { useNotificationStore } from '../../state/notificationStore';
import * as adminService from '../../services/adminService';
import * as foundationService from '../../services/foundationService';
import { KpiData, ProjectSummary, User, Feedback, KpiChartData, Submission, AdjudicationReport, StrategicInsight } from '../../types';
...
const AuraCommandCenter: React.FC = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            addNotification(`Failed to load command center data: ${error.message}`, 'error');
        } finally {
            setIsLoading(false);
        }
    }, [addNotification]);
    ...
    useEffect(() => {
        ...
        const intervalId = setInterval(() => {
            adminService.getKpiData().then(setKpiData).catch(err => console.error("KPI auto-refresh failed", err));
        }, 30000);
                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                            ...
                            <Suspense fallback={<div className="h-72 w-full flex items-center justify-center"><LoadingSpinner/></div>}>
        ...
        <div className="flex-grow p-4 md:p-8 overflow-y-auto animated-gradient-bg-studio">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-lg text-slate-300 mt-1 font-body">The owner's throne. Your automated mission control for Dakshin Vaarahi.</p>
                </div>
                ...
                <div className="border-b border-slate-600 mb-6">
                    <nav className="flex space-x-1 sm:space-x-4 overflow-x-auto">
                        ...
                        <TabButton isActive={activeTab === 'prize'} onClick={() => setActiveTab('prize')}>The Vaarahi Prize</TabButton>
                        ...
                        <TabButton isActive={activeTab === 'ai_tools'} onClick={() => setActiveTab('ai_tools')}>AI Arsenal</TabButton>
                    </nav>
                </div>
...
export default AuraCommandCenter;