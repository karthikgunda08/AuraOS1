...
import { BrahmaAstraMission, BrahmaAstraReport } from '../../types';
            ...
            <div className="w-full max-w-2xl bg-slate-800/50 backdrop-blur-md p-8 rounded-xl border border-slate-700 shadow-2xl">
                ...
                <div className="mt-8 flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="px-8 py-3 font-semibold text-white rounded-md bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-700 hover:to-orange-600 shadow-lg flex items-center gap-2"
                    >
                        <span className="text-lg">✨</span> Execute Mission (250 Credits)
                    </button>
                </div>
            </div>
        </div>
