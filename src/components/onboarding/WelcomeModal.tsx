...
const WelcomeModal: React.FC = () => {
    const { currentUser, setWelcomeModalOpen, refreshCurrentUser, completeOnboardingChecklistItem } = useAppStore();
    ...
    return (
        <div className="fixed inset-0 bg-background/90 backdrop-blur-lg z-[200] flex items-center justify-center p-4">
            <div className="w-full max-w-2xl text-center">
                <AuraLogo className="w-24 h-24 mx-auto text-primary" />
                ...
                <p className="text-slate-400 mt-6 max-w-xl mx-auto">
                    You've been granted <strong className="text-amber-300">100 complimentary AI Credits</strong> to explore the platform. Let's get your profile set up.
                </p>
