import { CreditPack, MaterialDefinition, Predefined3DModel } from './types';
...
export const PREDEFINED_MATERIALS: MaterialDefinition[] = [
  ...
  // Plaster
  { key: "plaster_stucco", name: "Stucco Plaster", type: "texture", value: "/textures/plaster_stucco.jpg", category: "Plaster", finish: "matte", appliesTo: "wall", uvScale: {x: 5, y: 5} },

  // Wood
  { key: "wood_oak_light", name: "Light Oak Wood", type: "texture", value: "/textures/wood_oak_light.jpg", category: "Wood", finish: "satin", appliesTo: "any", uvScale: { x: 5, y: 5 } },
  { key: "wood_walnut_dark", name: "Dark Walnut Wood", type: "texture", value: "/textures/wood_walnut_dark.jpg", category: "Wood", finish: "satin", appliesTo: "any", uvScale: { x: 4, y: 4 } },
  { key: "wood_panel_walnut", name: "Walnut Wall Panel", type: "texture", value: "/textures/wood_walnut_dark.jpg", category: "Wood", finish: "satin", appliesTo: "wall", uvScale: { x: 2, y: 8 } },
  
  // Stone
  { key: "stone_tile_marble_white", name: "White Marble Tile", type: "texture", value: "/textures/tile_marble_white.jpg", category: "Stone", finish: "glossy", roughness: 0.2, appliesTo: "floor", uvScale: { x: 3, y: 3 } },
  { key: "stone_travertine_light", name: "Light Travertine", type: "texture", value: "/textures/stone_travertine.jpg", category: "Stone", finish: "matte", appliesTo: "any", uvScale: { x: 3, y: 3 } },
  
  // Concrete
  { key: "concrete_smooth", name: "Smooth Concrete", type: "texture", value: "/textures/concrete_smooth.jpg", category: "Concrete", finish: "matte", appliesTo: "any", uvScale: { x: 2, y: 2 } },
  
  // Masonry
  { key: "masonry_brick_red", name: "Red Brick Wall", type: "texture", value: "/textures/brick_red.jpg", category: "Masonry", finish: "matte", appliesTo: "wall", uvScale: { x: 8, y: 10 } },
  ...
  { key: "tile_pattern_moroccan_blue", name: "Moroccan Blue Tile", type: "texture", value: "/textures/tile_moroccan_blue.jpg", category: "Tile", finish: "satin", appliesTo: "any", uvScale: { x: 10, y: 10 } },
