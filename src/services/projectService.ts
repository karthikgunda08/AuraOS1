...
import { User, Project, ProjectData, ProjectSummary, UpdateUserPayload, ChangePasswordPayload, ProjectStatus, BudgetCategory, ProjectTask, ProjectVersion, Collaborator, GeneratedDocument, GeneratedRender, MarketplaceInfo, ProjectAnalyticsData, HolocronData, DigitalTwinData } from '../types';
...
// --- NEW: Real Estate Exchange APIs ---

/**
 * Fetches all tokenized projects listed on the exchange. Public endpoint.
 */
...
/**
 * Tokenizes a project, listing it on the exchange.
