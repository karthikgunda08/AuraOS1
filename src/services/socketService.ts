...
import { ProjectData, ChatMessage, LiveCursor, LiveSelection, SelectedObject } from '../types';
...
export const emitCursorMove = (projectId: string, position: { x: number, y: number }) => {
